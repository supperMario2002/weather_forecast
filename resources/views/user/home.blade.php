                        ...
                        <div class="location-data">
                            ...
                            <div class="location-data-summary">
                                ...
                                <div class="overview-caption">
                                    ...
                                    <p id="cb-feeslike" class="overview-caption-item">Cảm giác như
                                        {{ $dataCurrent['feelslike_c'] }}°C.</p>
                                </div>
                                <div class="weather-detail mt-2">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex ml-auto align-items-center">
                                            <h3 id="cb-humidity" class="text-white op-8 fw-bold">
                                                {{ round($dataCurrent['humidity']) }}%</h3>
                                        </div>
                                    </div>
                                    <div class="separator-dashed"></div>
                                    <div class="d-flex">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex ml-auto align-items-center">
                                            <h3 id="cb-vis" class="text-white op-8 fw-bold">
                                                {{ $dataCurrent['vis_km'] }} km</h3>
                                        </div>
                                    </div>
                                    <div class="separator-dashed"></div>
                                    <div class="d-flex">
